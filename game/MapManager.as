package game {
	...
	public class MapManager {
		...
		public static function loadMapData(mapNumber:int) {
			...
			mapCode = map.mapCode;
			mapName = map.mapName;*/
			mapCode = MapDatabase.getMapCode(mapNumber);
			mapName = MapDatabase.getMapName(mapNumber);
			TileMap.removeTiles(mapClip);
			
			/*var tileset = MapDatabase.getTileset(map.tilesetID);
			var tileTypes = tileset.tileTypes;*/
			var tileTypes = MapDatabase.getTileTypes(mapNumber);
